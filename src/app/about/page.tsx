            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <h1 className="text-3xl font-bold mb-6 text-gray-800">Where it all Began</h1>
                        <p className="text-gray-600 mb-4">
                            An electronics engineering students bedroom back in 2013. In this picture my first workbench on a old computer stand with a 1980 motherboard on the bench can be seen on the right hand side with some electronics testing equipment.
